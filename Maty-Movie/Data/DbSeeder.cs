...
namespace Maty_Movie.Data
{
    public class DbSeeder
    {
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            var adminUser =
                await userManager.FindByEmailAsync("admin@admin.com");
            ...
            // Evitar cargar nuevamente los datos
            if (context.Peliculas.Any() ||
                context.Plataformas.Any() ||
                context.Generos.Any())
            {
                return;
            }
