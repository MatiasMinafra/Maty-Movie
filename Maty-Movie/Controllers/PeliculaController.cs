...
namespace Maty_Movie.Controllers
{
    public class PeliculaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,FechaLanzamiento,MinutosDuracion,Sinopsis,PosterUrlPortada,GeneroId,PlataformaId,PromedioRating")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,FechaLanzamiento,MinutosDuracion,Sinopsis,PosterUrlPortada,GeneroId,PlataformaId,PromedioRating")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
